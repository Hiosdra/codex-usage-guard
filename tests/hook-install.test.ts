...
describe("hook installation", () => {
  ...
  test("preserves other hooks and is idempotent", async () => {
  ...
  test("handles first install, missing files, malformed JSON, and command quoting", async () => {
  ...
  test("uses CODEX_HOME when no explicit hooks path is set", async () => {
